...
/**
    ...
    OWNER: EJ
    $Archive: /MNCB/Dev/LCX2AP/FIRMWARE/interface/ui/glue/ui_ffcustomvar.c $
    $Date: 1/09/12 3:14p $
    $Revision: 1 $
    $Author: EricJ $
