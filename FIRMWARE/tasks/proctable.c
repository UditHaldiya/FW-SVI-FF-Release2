    ...
    { //by design: restores control mode only if fails
        ...
        { //rather stealth
            [PROCRESULT_OK] =
            {
                .event = FAULT_NONE,
                .UIplace = UINODEID_SETUPNODE,
                .termflags = PROCTERMFLAG_NOCTLMODE, //leave the valve positioned at the end position
...
#endif
    periodicjob_Temperature, //need to do it right away
