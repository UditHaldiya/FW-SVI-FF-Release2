...
/**
    ...
    OWNER: AK
    $Archive: /MNCB/Dev/LCX2AP/FIRMWARE/inc_SVI2AP/mncbdefs_proj.h $
    $Date: 1/12/12 11:57p $
    $Revision: 3 $
    $Author: Arkkhasin $
...
#define MNCB_MANUFACTURER_DEVICE_CODE   0x02 //0xfe //202U //! HART device id (AP)

#define MNCB_MAGIC_NUMBER ((ASCII_M<<8)|ASCII_N) //!Device type FRAM id

#define MNCB_HW_REV 4U
