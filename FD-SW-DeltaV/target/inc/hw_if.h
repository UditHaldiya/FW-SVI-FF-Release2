...
*/
#define USE_WD_INSTRUM 1 //! If non-zero, compiles in time measurement between tickles in WDInstrum
#define USE_WDT_INSTRUM 1 //! If non-zero, compiles in time measurement between tickles by tasks in WDTInstrum
...
/*****************************************************************************/
/* global function declarations from file:      hw_hm.c                      */
/*****************************************************************************/

FUNCTION extern VOID hw_hm_init(VOID);
FUNCTION extern USIGN8 hw_hm_set_baudrate (USIGN16 baudrate);
