...
FUNCTION PUBLIC VOID init_svi_dwnld()
...
FUNCTION PUBLIC USIGN8 verify_activation()
/*----------------------------------------------------------------------------
FUNCTIONAL_DESCRIPTION
...
FUNCTION_BODY
  ...
  /* here it could be checked whether the domain from the intended Flash bank was activated */
