...
#define SFT_STD_PARM_dev_rev             0x01      /*  Standard Parameters       DD-LIB V3.70 */
#define SFT_STD_XDCR_PARM_dev_rev        0xFF      /*  Transducer Parameters     DD-LIB V3.70, 013E\01xx not available */
#define SFT_ADV_PARAM_dev_rev            0x01      /*  Advanced Parameters       DD-LIB V3.70 */
...
#define SFT_AO_BLOCK_dev_rev             0x01      /*  DD-LIB V3.70 */
#define SFT_DO_BLOCK_dev_rev             0x01      /*  DD-LIB V3.70 */
...
#define SFT_INPUT_SELECTOR_dev_rev       0x01      /*  Input Selector            DD-LIB V3.70 */
#define SFT_ARITHMETIC_dev_rev           0x01      /*  Arithmetic                DD-LIB V3.70 */
#define SFT_OUTPUT_SPLITTER_dev_rev      0x01      /*  Output Splitter           DD-LIB V3.70 */
...
#define SFT_MAI_dev_rev                  0x01      /*  Multiple Analog Input     DD-LIB V3.70 */
#define SFT_MAO_dev_rev                  0x01      /*  Multiple Analog Output    DD-LIB V3.70 */


/* FF DD revisions used for DD import */
#define SFT_STD_PARM_dd_rev              0x0A      /*  Standard Parameters       DD-LIB V3.70 */
#define SFT_STD_XDCR_PARM_dd_rev         0x04      /*  Transducer Parameters     DD-LIB V3.70 */
#define SFT_ADV_PARAM_dd_rev             0x05      /*  Advanced Parameters       DD-LIB V3.70 */
#define SFT_MIO_PARM_dd_rev              0x01      /*  Std Parms for MIO blocks  DD-LIB V3.70 */

#define SFT_RES_BLOCK_2_dd_rev           0x04      /*  DD-LIB V3.70 */

#define SFT_PID_BLOCK_dd_rev             0x04      /*  DD-LIB V3.70 */
#define SFT_AI_BLOCK_dd_rev              0x04      /*  DD-LIB V3.70 */
#define SFT_DI_BLOCK_dd_rev              0x04      /*  DD-LIB V3.70 */
#define SFT_AO_BLOCK_dd_rev              0x04      /*  DD-LIB V3.70 */
#define SFT_DO_BLOCK_dd_rev              0x04      /*  DD-LIB V3.70 */
...
#define SFT_INPUT_SELECTOR_dd_rev        0x04      /*  Input Selector            DD-LIB V3.70 */
#define SFT_ARITHMETIC_dd_rev            0x03      /*  Arithmetic                DD-LIB V3.70 */
#define SFT_OUTPUT_SPLITTER_dd_rev       0x04      /*  Output Splitter           DD-LIB V3.70 */
...
#define SFT_MAI_dd_rev                   0x02      /*  Multiple Analog Input     DD-LIB V3.70 */
