...
#if 0 //No translation in FFP yet
static const ExtraData_t FFPExtraData =
{
    ...
    .dummyPtr = NULL,
    .VerInfo = VerString,
    .vertran = NULL, //no vertran in FFP (yet?),
};
#endif
...
const vectors_t __vector_table =
{
    ...
    .Fnct =
    {
        ...
        /* TIM1 Trigger and Commutation and TIM11 */  HART_timer_irq,
    ...
    .ExtraData = NULL, //not yet &FFPExtraData,
};
