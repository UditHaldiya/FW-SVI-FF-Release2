...
define VC_PLUGIN
    ...
    $(OFFVCS) workfold /map "$$/$(TFSProject)/Release2/ForHoneywell/FD-SW" $(SISTER_OFFroot) /workspace:$(OFFworkspace) $(OFFlogin)
    $(PAUSE)
...
define BUILD_PLUGIN
    ...
    $(PAUSE)
	hex2ffd.exe $(SISTER_BUILD_DIR)\$(SISTER_PROJ)_0.hex $(SISTER_BUILD_DIR)\$(SISTER_PROJ)_1.hex $(BTARGET:$(PROG).mns=$(PROJ).hex) $(BTARGET:$(PROG).mns=$(PROJ)_1.hex) $(BTARGET:.mns=.tmp.ffd)
