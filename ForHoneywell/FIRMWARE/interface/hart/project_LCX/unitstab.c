...
/**
    ...
    OWNER: AK
    $Archive: /MNCB/Dev/LCX2AP/FIRMWARE/interface/hart/project_LCX/unitstab.c $
    $Date: 1/23/12 2:11p $
    $Revision: 1 $
    $Author: Arkkhasin $
 ...
 * 
 * *****************  Version 1  *****************
 * User: Arkkhasin    Date: 1/23/12    Time: 2:11p
 * Created in $/MNCB/Dev/LCX2AP/FIRMWARE/interface/hart/project_LCX
