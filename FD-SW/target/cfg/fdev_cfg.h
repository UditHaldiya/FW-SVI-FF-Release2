...
=========================================================================== */
#ifndef __FDEV_CFG_H__
#define __FDEV_CFG_H__
...
/* --- NV RAM and extra NV RAM cycle time -------------------------------- */
...
/* ------------------------------------------------------------------------ */
  ...
  #define DEV_CONFIG_REVISION       33   //Changed for bug 23078 which when fixed lost TB)
