...
----------------------------------------------------------------------
File    : RTOSInit_TMPM369_CMSIS.c for Toshiba TMPM369

Purpose : Initializes and handles the hardware for emOS as far
...
#include "RTOS.h"
#include "TMPM369.h"     // Device specific header file, contains CMSIS
...
**********************************************************************
*/
#define NVIC_VTOR             (*(volatile OS_U32*)(0xE000ED08))
